...
def find_symprec(raw_txt, *, n=2, symprec=1e-3, angle_tolerance=5.0, occupancy_tolerance:float = 1.0, merge_tolerance:float = 0.01):
    """
...
class StructureEntry:
    ...
    @classmethod
    def from_txt(cls, raw_txt, *, code = None, meta=None, symprec=1e-3, angle_tolerance=5, occupancy_tolerance: float = 1.0, source: str = 'None', conventional_struct: bool = True, refine_struct: bool = False):
